<?php
	...
	*@author Kery Pérez
	*@version 1.0
	*@package administracionV
	*
	*/
	class administracionV extends templeteV  
	{
		/**
		*
		*Constructor
		...
		*/
		function registrarRoles($form="",$evento="",$id="")
		{
							...
							<tr>
								<td align=\"center\">
									<div id=\"boton\" style=\"text-align:center\">
										<br />
										<img id=\"btnguardar_actDesOperador\" src=\"../imagenes/boton_guardar.png\" onclick=\"xajax_modificarRol(xajax.getFormValues('registro'),".$id.");\" onmouseover=\"javascript:document.getElementById('btnguardar_actDesOperador').src='../imagenes/boton_guardar_on.png'\" onmouseout=\"javascript:document.getElementById('btnguardar_actDesOperador').src='../imagenes/boton_guardar.png'\"/><br />
