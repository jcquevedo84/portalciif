<?php
	...
	*
	*/
	class proyectoV extends templeteV  
	{
		/**
		*
		*Constructor
		...
		*/
		function registrarProyecto($form="",$evento="",$id="")
		{
			if(!empty($form) and is_array($form))
			{
				...
				$fechaCreacion="value=\"".htmlentities($form[1][4])."\"".$bloqued;
			}
			else 
			{
				$nombre="";
						...
						<table width=\"720px\" align=\"center\">
							...
							<tr>
								<td class=\"tdtitulo_form\" align=\"center\">
									<p class=\"titulo_secciones\">Datos del Proyecto</p>
								</td>
							</tr>
							<tr>
								<td align=\"center\">
									...
									<table width=\"700px\" style=\"font-size:12px\">
							           	...
							           	<tr>
							                <td width=\"280px\" align=\"right\">
							                    Fecha Creaci&oacute;n<sup class=\"asterisk\">*</sup>:
							                </td>
											<td width=\"440px\" align=\"left\">
                                               <input class=\"texto_textarea\" type=\"text\" name=\"txtfecha1\" id=\"txtfecha1\" readonly=\"readonly\" size=\"10\" style=\"background-color:#f5f5f5; vertical-align:middle\" ".$fechaCreacion."/>
							...
							<tr>
								<td align=\"center\">
									<div id=\"boton\" style=\"text-align:center\">
										<br />
										<img id=\"btnguardar_actDesOperador\" src=\"../imagenes/boton_guardar.png\" onclick=\"xajax_modificarProyecto(xajax.getFormValues('registro'),".$id.");\" onmouseover=\"javascript:document.getElementById('btnguardar_actDesOperador').src='../imagenes/boton_guardar_on.png'\" onmouseout=\"javascript:document.getElementById('btnguardar_actDesOperador').src='../imagenes/boton_guardar.png'\"/><br />
